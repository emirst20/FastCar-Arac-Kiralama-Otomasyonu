...
namespace AracKiralamaOtomasyonu.Controllers
{
    ...
    public class IlanController : Controller
    {
        ...
        public ActionResult Ilanlar(string ara,string marka, string modeli, string vites,string kasa, string yakit,string cekis, int? minfiyat, int? maxfiyat)
        {
            ...
            var sorgu = db.Ilanlar.Include("AracMarka").Include("AracModel").Include("AracGuvenlik").Include("AracDisDonanim").Include("AracIcDonanim").Include("AracMultiMedya").Include("Dosyalar").Where(x=>x.Durum ==3).ToList();
